...
namespace UserStorage.Tests
{
    ...
    public class UserEqualsTests
    {
        ...
        {
            User firstUser = new User("Name", "Surname", "", new DateTime(2000, 1, 1), Gender.Male, null);
            User secondUser = new User("Name", "Surname", "", new DateTime(2000, 1, 1), Gender.Male, null);
        ...
        {
            User firstUser = new User("Name", "Surname", "", new DateTime(2000, 1, 1), Gender.Male, null);
            User thirdUser = new User("OtherName", "Surname", "", new DateTime(2000, 1, 1), Gender.Male, null);
