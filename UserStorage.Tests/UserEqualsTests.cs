...
namespace UserStorage.Tests
{
    ...
    public class UserEqualsTests
    {
        ...
        {
            User firstUser = new User(0, "Name", "Surname", string.Empty, new DateTime(2000, 1, 1), Gender.Male, null);
            User secondUser = new User(0, "Name", "Surname", string.Empty, new DateTime(2000, 1, 1), Gender.Male, null);
        ...
        {
            User firstUser = new User(0, "Name", "Surname", string.Empty, new DateTime(2000, 1, 1), Gender.Male, null);
            User thirdUser = new User(0, "OtherName", "Surname", string.Empty, new DateTime(2000, 1, 1), Gender.Male, null);
